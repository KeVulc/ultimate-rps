...
const HeadToHead = ({ headToHeadData, isFirst }) => {
  ...
  return (
    <div className='bg-[#93A87E] text-[#313036] p-6 rounded-lg shadow-lg w-full max-w-md my-6 border-2 border-[#313036] font-SIL text-4xl'>
      <div className='flex justify-between items-center mb-4'>
        <div className='text-center'>
          <h3 className='text-5xl font-bold'>{first_user.name}</h3>
          <p className=''>{first_user.score}</p>
        </div>
        <span className='text-6xl text-[#815ca7]'>vs</span>
        <div className='text-center'>
          <h3 className='text-5xl font-bold'>{second_user.name}</h3>
